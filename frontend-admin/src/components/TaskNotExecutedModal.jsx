...
/**
 * Close a task as "not executed" with a mandatory free-text reason.
        ...
        <>
          <div style={{
            ...
            <div style={{ color: 'var(--text2)' }}>
              המשימה תיסגר ללא ביצוע. אם קיימת כרטסת — יירשם אירוע "לא בוצעה" בכרטסת. הכרטסת/קופה לא ישתנו.
            </div>
          </div>
